...
public class BookingController {
    ...
    public boolean process() {
        String[] titles = { "Flight Number", "Airline Name", "Dep. Airport", "Depa. Date", "Arr. Airport", "Arr. Date", "No. of Seats"};
        String[][] details = {{this.flightNumber,this.airlineName,this.departureAirport,this.departureDate.toString(),this.arrivalAirport,this.arrivalDate.toString(),this.countOfSeats}};
